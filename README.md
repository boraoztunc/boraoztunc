...
Currently, I'm building a product design and development studio; <a class="goto-social" href="https://1984.design" target="_blank">1984 Design Corp</a>. As a product designer, and with a small team of designers and developers, we are working with brands, startups, and entrepreneurs to build visionary digital experiences, from concept to scale.
...
![Metrics](https://metrics.lecoq.io/boraoztunc?template=classic&followup=1&isocalendar=1&languages=1&pagespeed=1&stars=1&pagespeed.detailed=false&pagespeed.screenshot=false&isocalendar.duration=half-year&stars.limit=4&config.timezone=Europe%2FIstanbul)
